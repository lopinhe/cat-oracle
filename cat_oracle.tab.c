...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_QUESTION = 3,                   /* QUESTION  */
  YYSYMBOL_WHAT = 4,                       /* WHAT  */
  YYSYMBOL_WHO = 5,                        /* WHO  */
  ...
  YYSYMBOL_question = 14,                  /* question  */
  YYSYMBOL_question_what = 15,             /* question_what  */
  YYSYMBOL_question_who = 16,              /* question_who  */
  YYSYMBOL_question_when = 17,             /* question_when  */
  YYSYMBOL_question_where = 18,            /* question_where  */
  YYSYMBOL_question_how = 19               /* question_how  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "QUESTION", "WHAT",
  "WHO", "WHEN", "WHERE", "HOW", "EOL", "$accept", "start", "$@1", "input",
  "question", "question_what", "question_who", "question_when",
  "question_where", "question_how", YY_NULLPTR
};
...
{
       0,    11,    12,     0,    13,     3,     4,     5,     6,     7,
       8,    14,    15,    16,    17,    18,    19,     9,     3,     3,
       3,     3,     3,     9,     9,     9,     9,     9
};
